...
?>
	...
	<div id="connect">
		...
		<div <?php if ( $related_posts != '' ) echo 'class="col-left"'; ?>>
			<p><?php if ($woo_options[ 'woo_connect_content' ] != '') echo stripslashes($woo_options[ 'woo_connect_content' ]); else _e('We post all our jobs on the social networks. Follow us and keep updated with our latest jobs.', 'woothemes'); ?></p>
